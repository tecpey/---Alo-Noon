...
export const PROVIDER_ERROR_MESSAGES: Readonly<Record<string, string>> = {
  ...
  WITHDRAWAL_FORBIDDEN: 'این حساب اجازهٔ بررسی برداشت مشتری‌ها را ندارد.',
  WITHDRAWAL_NOT_FOUND: 'چنین درخواست برداشتی وجود ندارد.',
  WITHDRAWAL_ALREADY_SETTLED: 'این درخواست قبلاً بررسی شده است.',
  INVALID_REJECTION_REASON: 'دلیل رد را بنویسید؛ مشتری همین متن را می‌بیند.',
  WITHDRAWAL_UNAVAILABLE: 'میز برداشت موقتاً در دسترس نیست. کمی بعد دوباره تلاش کنید.',
