...
ریپو در **Phase 2D Server Cart & Quote** قرار دارد. علاوه بر زیرساخت Phase 0 و
Domain Foundation، API شهرهای فعال، کاتالوگ و محدوده سرویس، OTP و Session امن،
RBAC، Cart سروری وابسته به مشتری، کنترل نسخه، قیمت‌گذاری مجدد سمت سرور، Quote
زمان‌دار و snapshotهای غیرقابل‌تغییر و اتصال اپ مشتری به این جریان‌ها پیاده‌سازی
شده‌اند. اتصال ارائه‌دهنده تأییدشده پیامک، تبدیل Quote به Order، قیمت‌گذاری
نهایی ارسال، پرداخت و Ledger، پنل‌های کامل، Dispatch، ارسال اعلان و اجرای چاپ
هنوز باید در فازهای بعدی ساخته شوند.
