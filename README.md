...
ریپو در **Phase 2C Customer App Integration** قرار دارد. علاوه بر زیرساخت Phase
0 و Domain Foundation، API فقط‌خواندنی شهرهای فعال، کاتالوگ و بررسی محدوده
سرویس، OTP امن، Session سروری قابل ابطال، RBAC محدوده‌محور، Migrationهای
PostgreSQL/Prisma، OpenAPI و اپ مشتری متصل به این جریان‌ها پیاده‌سازی شده‌اند.
اتصال ارائه‌دهنده تاییدشده پیامک، Cart، Quote، Commerce تراکنشی، پرداخت و
Ledger، پنل‌های کامل، Dispatch، ارسال اعلان و اجرای چاپ هنوز باید در فازهای بعدی
ساخته شوند.
