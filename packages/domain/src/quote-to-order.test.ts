...
function candidate(overrides: Partial<QuoteToOrderCandidate> = {}): QuoteToOrderCandidate {
  return {
    ...
    deliveryServiceAreaIdSnapshot: 'area-a',
    deliveryOperationalZoneIdSnapshot: 'zone-a',
    deliveryDistanceMeters: 1_234,
    bakeryNameSnapshot: 'Bakery',
    bakeryPickupSnapshot: 'Pickup address',
...
describe('Quote-to-Order authorization', () => {
  it('authorizes a complete active quote owned by the tenant customer', () => {
    expect(authorizeQuoteToOrder(candidate(), now)).toEqual({
      ...
      customerId: 'customer-a',
      deliveryAddressId: 'address-a',
      deliveryServiceAreaId: 'area-a',
      deliveryOperationalZoneId: 'zone-a',
      deliveryDistanceMeters: 1_234,
      deliveryPricingRuleId: 'rule-a',
      deliveryPricingRuleVersion: 3,
      totalAmount: 115_000n,
  ...
  it.each([
    ...
    [{ deliveryServiceAreaIdSnapshot: null }, 'QUOTE_DELIVERY_SNAPSHOT_INCOMPLETE'],
    [{ deliveryOperationalZoneIdSnapshot: null }, 'QUOTE_DELIVERY_SNAPSHOT_INCOMPLETE'],
    [{ deliveryDistanceMeters: -1 }, 'QUOTE_DELIVERY_SNAPSHOT_INCOMPLETE'],
    [{ bakeryNameSnapshot: null }, 'QUOTE_DELIVERY_SNAPSHOT_INCOMPLETE'],
    ...
    [{ itemSnapshotsComplete: false }, 'QUOTE_DELIVERY_SNAPSHOT_INCOMPLETE'],
