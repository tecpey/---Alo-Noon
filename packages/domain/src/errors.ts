export type DomainErrorCode =
  ...
  | 'INVALID_VEHICLE_POLICY'
  | 'INVALID_COVERAGE_RADIUS'
  | 'INVALID_COVERAGE_CENTRE'
  | 'INVALID_COVERAGE_SEGMENTS'
  ...
  | 'INVALID_PROMOTION_TERMS'
  | 'INVALID_AMOUNT'
  | 'INVALID_SETTLEMENT'
  | 'INVALID_WALLET_MOVEMENT'
